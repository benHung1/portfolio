          ...
          colleagues: [
            {
              ...
              content: "班班在程式碼審查時總能提出建設性的意見，幫助團隊提升程式碼品質。他對技術細節的把控很到位，寫出來的程式碼不僅功能完整，還兼顧了可維護性和擴展性。在 code review 時總能發現一些我們沒注意到的問題。",
            },
            {
              name: "elis",
              role: "member",
              avatar: "https://images.1111.com.tw/event/img/event25/aiMatch/avatars/personality-avatar-05w.webp",
              content: "班班是個很熱心的同事，技術能力強，遇到問題時總是很樂意幫忙。他的溝通能力很好，能夠清楚解釋技術概念，讓團隊成員更容易理解。在專案開發中總是能提供優雅的解決方案。",
            },
            {
              name: "yichia",
              role: "member",
              avatar: "https://images.1111.com.tw/event/img/event25/aiMatch/avatars/personality-avatar-04w.webp",
              content: "班班在重構舊專案時展現出很強的技術判斷力，能夠在保持功能穩定的前提下，逐步改善程式碼結構。他建立的組件庫讓我們開發效率提升不少，新專案可以直接套用，省了很多時間。"
            },
            {
              name: "小楊",
              role: "member",
              avatar: "https://images.1111.com.tw/event/img/event25/aiMatch/avatars/personality-avatar-05m.webp",
              content: "班班在導入 Nuxt 3 時做了很多研究，從技術選型到實際落地都考慮得很周全。他會主動分享學習心得和踩過的坑，讓我們少走很多彎路。跟他合作開發專案很順暢，因為他總能把需求理解得很透徹。",
            },
          ],
        },
        links: {
          ...
          colleagues: [
            {
              ...
              role: "Frontend Lead",
              avatar: "https://images.1111.com.tw/event/img/event25/aiMatch/avatars/personality-avatar-04m.webp",
              content: "Benben always provides constructive feedback during code reviews, helping the team improve code quality. He has excellent attention to technical details, and his code is not only functionally complete but also maintains good maintainability and scalability. During code reviews, he always catches issues we might have missed.",
            },
            {
              name: "elis",
              role: "member",
              avatar: "https://images.1111.com.tw/event/img/event25/aiMatch/avatars/personality-avatar-05w.webp",
              content: "Benben is a very helpful colleague with strong technical skills who's always willing to help when problems arise. He has good communication skills and can clearly explain technical concepts, making it easier for team members to understand. In project development, he can always provide elegant solutions.",
            },
            {
              name: "yichia",
              role: "member",
              avatar: "https://images.1111.com.tw/event/img/event25/aiMatch/avatars/personality-avatar-04w.webp",
              content: "Benben demonstrates strong technical judgment when refactoring legacy projects, able to gradually improve code structure while maintaining functional stability. The component library he built significantly improved our development efficiency - new projects can directly apply it, saving us a lot of time.",
            },
            {
              name: "Xiao Yang",
              role: "member",
              avatar: "https://images.1111.com.tw/event/img/event25/aiMatch/avatars/personality-avatar-05m.webp",
              content: "Benben did extensive research when introducing Nuxt 3, considering everything from technology selection to actual implementation. He proactively shares learning insights and pitfalls he encountered, helping us avoid many detours. Collaborating with him on projects is smooth because he always understands requirements thoroughly.",
            },
          ],
        },
        links: {
